          ...
          <el-form-item class="input" label="材料" prop="cailiao">
              <el-input v-model="ruleForm.cailiao" 
                placeholder="材料" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="份量" prop="fenliang">
          <el-input v-model="ruleForm.fenliang" 
              placeholder="份量" clearable  :readonly="ro.fenliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="份量" prop="fenliang">
              <el-input v-model="ruleForm.fenliang" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.caipinjieshao = this.ruleForm.caipinjieshao.replace(reg,'../../../springbootc3op5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
